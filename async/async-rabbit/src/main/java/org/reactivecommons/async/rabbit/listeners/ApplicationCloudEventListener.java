...
@Log
public class ApplicationCloudEventListener extends GenericMessageListener {
    ...
    public ApplicationCloudEventListener(ReactiveMessageListener receiver,
                                         String queueName,
    ...
    protected Function<Message, Mono<Object>> rawMessageHandler(String executorPath) {
        final RegisteredCloudEventHandler handler = resolver.getCloudEventListener(executorPath);
    ...
    protected Object parseMessageForReporter(Message msj) {
        return messageConverter.readCloudEvent(msj);
    }
